...
import ListViewItem from './ListViewCourse';
        ...
        if (this.state.dataList.length) {
            listView = (
                <SortableListView
                    ...
                    renderRow={(dataItem, section, index) => <ListViewCourse data={dataItem} navigation = {navigate} onCompletedChange={this._onCompletedChange}/>}
                />
            );
        }
